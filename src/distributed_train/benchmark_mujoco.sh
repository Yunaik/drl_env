...
do
    ...
    for batch_size in 100 150 200 300 400
    do
        for core in 8
        do
            ...
            for enlarge in 3
            do
                # for amount_of_env in 20
                for amount_of_env in 20 50 100 150
                do
                    echo ===============================Start===========================================
                    echo Running physx backend: $backend, batch_size: $batch_size, core: $core, enlarge: $enlarge, amount_of_env: $amount_of_env
                    echo -----------------------------------------------------------------------------
                    bash start_env_servers.sh $amount_of_env & # start the servers in background
                    ...
                    python3 mujoco_parallel_batch.py --backend $backend --batch_size $batch_size --core $core --enlarge $enlarge --amount_of_env $amount_of_env 
