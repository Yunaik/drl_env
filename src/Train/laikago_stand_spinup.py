...
def main(args):
	...
	logger_kwargs = setup_logger_kwargs('laikago', args.seed)

	sac(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs = dict(hidden_sizes=[256] * 2), gamma = args.gamma, seed = args.seed, epochs = 1000000, logger_kwargs = logger_kwargs, max_ep_len = 125)
...
def show(args):
	...
	_, get_action = load_policy('/home/syslot/DevSpace/WALLE/src/data/laikago_s666')

	imgs = run_policy(env, get_action, render= cfg['is_render'], max_ep_len = 250, num_episodes = 10)
