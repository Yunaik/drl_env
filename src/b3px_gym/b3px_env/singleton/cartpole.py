...
class CartPoleBulletEnv(gym.Env):
    ...
    def __init__(self, client, plane=None, pos=[0,0,0], renders=False, discrete_actions=True):
        self._p = client
    ...
    def set_pos(self, action):
        ...
        self._p.setJointMotorControl2(self.cartpole, 0, self._p.TORQUE_CONTROL, force=force)
    ...
    def get_observation(self):
        # print("Get joint")
        self.state = self._p.getJointState(self.cartpole, 1)[0:2] + self._p.getJointState(self.cartpole, 0)[0:2]
        # print("Get joint2")
        return self.state
    ...
    #     self._p = bc.BulletClient()
        ...
        # self.cartpole = p.loadURDF("/home/kai/physx/physx/src/urdf/cartpole.urdf", )
        self.cartpole = self._p.loadURDF("/home/kai/physx/physx/src/urdf/cartpole.urdf", self.pos)
